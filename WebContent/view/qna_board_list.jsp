	...
	<div class="box box-primary">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<button type="button" onclick="location.href='index.html'" class="btn btn-info">게시판 홈</button>
			</div><!--글쓰기 버튼-->
		...
		<table class="table table-bordered">
			...
			<tr><!-- 리스트 목록 보여주기 -->
				...
				<td class='text-center'>${vo.readcount}<span class="badge badge-pill badge-primary"></span></td><!-- 조회수 -->
			</tr>		
			</c:forEach>
		</table>
		<div class="container">
